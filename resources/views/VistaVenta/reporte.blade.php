                                        ...
                                        <div class="flex ml-4  justify-end text-right  ">
                                            ...
                                            <div>
                                                ...
                                                <form action="{{ route('venta.destroy', $v->id) }}" method="POST">
                                                    ...
                                                    <button type="submit" title="ELIMINAR" onclick="return confirm('¿Desea eliminar la venta?')" class="w-fit py-2 rounded-lg text-white hover:scale-125 transition-transform delay-75">
