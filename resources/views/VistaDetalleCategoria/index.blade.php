...
<div class="py-5">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-1">
        <div class="bg-white overflow-hidden sm:rounded-lg"
            ...
            <form action="{{route('detallecategoria.store')}}" method="POST"
                  class="p-4 space-y-4"> <!-- Agregamos padding y espacio vertical entre elementos -->
                @csrf
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <p for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Detalle Categoria</p>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg"
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-row items-center">
                        <h2 class="text-2xl font-semibold ml-4">Detalle Categorias</h2>
