                                        ...
                                        <div class="flex ml-4  justify-end text-right  ">
                                            ...
                                            <div>
                                                ...
                                                <form action="{{ route('compra.destroy', $v->id) }}" method="POST">
                                                    ...
                                                    <button type="submit" title="ELIMINAR" onclick="return confirm('¿Desea eliminar la venta?')" class="w-fit py-2 rounded-lg text-white hover:scale-105 transition-transform delay-75">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
