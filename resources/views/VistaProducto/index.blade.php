...
<div class="py-2 px-18">
    <div class="flex justify-between items-center">
        ...
        <div class="py-1">
            <div class="bg-white overflow-auto shadow-sm rounded-lg p-4 min-h-[100vh] max-w-8xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <form action="{{ route('producto.index') }}" method="GET">
                        <div class="mt-2 mb-3">
                            <div class="relative mb-1 flex w-full flex-wrap items-stretch">
                                ...
                                <!--Search button-->
                                <button
                                    class="type=submit relative z-[2] flex items-center rounded-r bg-red-500 px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-red-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-700 active:shadow-lg"
                        ...
                        <tbody class=" ">
                         ...
                         hover:bg-gray-100 transition">
                                    ...
                                    <td class="px-8 py-3 text-sm capitalize ">
                                        <img src="/imagen/{{ $p->imagen }}" class="w-12 h-15 rounded mx-auto"
                                            alt="">
                                    </td>
