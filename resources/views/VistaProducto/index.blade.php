                ...
                <div class="bg-white overflow-x-auto  shadow-sm sm:rounded-lg">
                    <div class="p-6  bg-white border-b border-gray-200">
                        <div class="flex flex-row items-center">
                            <h2 class="text-2xl font-semibold ml-4">Lista de Productos</h2>
                            <form action="{{ route('producto.index') }}" method="GET" class="ml-4 flex">
                                <input type="text" name="buscar"
                                    class="border border-gray-300 bg-gray-100 h-10 px-3 rounded-full w-full placeholder-gray-500"
                                    placeholder="Buscar" value="{{ $buscar }}">
                                    <button type="submit" class="bg-blue-500 text-white px-2 py-1 rounded-full ml-2"><span
                                        class="material-symbols-outlined">Buscar</span></button>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 mt-4">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @foreach ($productosCoincidentes as $p)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->codigo }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->nombre }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->precio }} </td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->cantidad }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->autor }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->version }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->editorial }}</td>
                                        <td class="px-6 py-4 whitespace-no-wrap">{{ $p->ubicacion }}</td>
