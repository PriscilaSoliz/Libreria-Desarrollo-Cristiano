                ...
                <div class="bg-white overflow-x-auto shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="flex flex-row items-center">
                            <h2 class="text-2xl font-semibold ml-4">Categorias de Productos</h2>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-300 mt-4">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="px-6 py-1 whitespace-no-wrap">nombre</td>
                                        <td class="px-6 py-1 whitespace-no-wrap">Libros</td>
                                        <td class="px-6 py-1 whitespace-no-wrap">Niño</td>
