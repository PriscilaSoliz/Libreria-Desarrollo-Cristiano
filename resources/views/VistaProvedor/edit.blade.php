    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="shadow-lg sm:rounded-lg">
                ...
                <form action="{{ route('producto.update', $provedor->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <!-- Indica que esta es una solicitud PUT para actualizar -->
                        ...
                        <div>
                            ...
                            <input type="text" name="codigo" id="codigo" value="{{ $provedor->ci }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ $provedor->nombre }}"
                                   class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>

                        <div>
                            <label for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Nombre Producto</label>
                            <input type="text" name="nombre" id="nombre" value="{{ $provedor->celular }}"
                                   class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>

                        <div>
                            <label for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Nombre Producto</label>
                            <input type="text" name="nombre" id="nombre" value="{{ $provedor->direccion }}"
                                   class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                        </div>
