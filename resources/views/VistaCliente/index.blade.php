                ...
                <a href="#">Importar</a> --}}
                    ...
                    <table class="table-auto w-full">
                        <div class="text-center mt-4">
                            <a class="text-1xl font-mono font-semibold text-gray-500">LISTA DE CLIENTE</a>
                        </div>
                        <thead>
                            <tr class="text-xs text-left font-semibold text-gray-500">
                                ...
                                <th class="px-6 py-3 text-center">Direccion</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($cliente as $c)
                                <tr class="bg-white text-gray-700 hover:border-white hover:bg-gray-100 transition">
                                    ...
                                    <td class="py-3 text-sm text-center">{{ $c->ci }}</td>
