...
@section('content')
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mx-auto my-5 p-6"
            ...
            <h2 class="text-2xl font-semibold text-center mb-4">Asignar un rol</h2>
            @if (session('info'))
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="h5 mt-4">Listado de roles</p>
    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mx-auto my-5 p-6"
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                ...
                <div class="flex justify-center mt-4">
                    <button type="submit" name="update_button" value="update" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded sm:w-auto">Guardar Cambios</button>
