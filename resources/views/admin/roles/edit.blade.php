...
@section('content')
    ...
    @endif
    <div class="py-1">
        <div class="max-w-3xl mx-auto p-1 sm:p-1 lg:p-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mx-auto my-5 p-1"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, [
                            'class' => 'w-full p-2 border rounded-md mt-1 text-black',
                    ...
                    @foreach ($permissions as $permission)
                        <div class="flex items-center mt-2">
                            {!! Form::checkbox('permissions[]', $permission->id, null, [
                                'class' => 'h-5 w-5 text-indigo-600 border-gray-300 rounded focus:ring-indigo-400',
                            ]) !!}
                    ...
                    <div class="text-center">
                        {!! Form::submit('Actualizar Rol', [
                            'class' => 'bg-indigo-500 text-white rounded-md p-2 mt-4 hover:bg-indigo-600 mx-auto',
                        ]) !!}
                    </div>
                    {!! Form::close() !!}
                </div>
