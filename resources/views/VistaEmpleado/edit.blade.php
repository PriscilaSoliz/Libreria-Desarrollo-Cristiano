            ...
            <form action="{{ route('empleado.update', $empleado->id) }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ $empleado->nombre }}" class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="direccion" id="direccion" value="{{ $empleado->direccion }}" class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                    <div>
                        <label for="cargo" class="block text-gray-700 text-sm font-bold mb-2">Cargo</label>
                        <input type="text" name="cargo" id="cargo" value="{{ $empleado->cargo }}" class="border rounded-lg py-2 px-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
                <div class="mt-4">
